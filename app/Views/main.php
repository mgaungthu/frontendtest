...
<head>
    ...
    <title>Ironsoftware for C++</title>
    ...
    <link href="iron-software-favicon.png" rel="icon" type="image/png">
    ...
    <header>
        <nav class="navbar navbar-expand-lg p-0">
            <div class="container-fluid">
                <a class="navbar-brand" href="index.html"><img class="main-logo" src="images/logo.svg"
                        alt="Iron Software"></a>
        ...
        <section class="margin-2-rem-bottom margin-5-rem-top">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <img src="images/colorful-logo.svg" alt="Iron Software">
                        <h5 class="sub-title text-white margin-2-rem-top">
                           <?=$sub_title?>
                        </h5>
                        <h3 class="main-title text-white">
                            <?=$title?><br>
                            <span class="text-dark-purple ">IronPDF for C++</span>
                        </h3>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 d-flex justify-content-center position-relative margin-3-rem-top">
                        ...
                        <img src="images/coming-soon.png" class="float-coming" alt="">
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 text-lg-left text-center">
                        <img src="images/html-to-pdf.png" class="img-fluid" alt="HTML to PDF converter">
                    </div>
                    <div class="col-lg-9">
